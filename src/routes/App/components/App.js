...
const  App=()=> {
  ...
  useLayoutEffect(() => {
    ...
    root[0].className = darkMode?'dark-mode':''
  }, [darkMode])
  ...
  return (
    <div className={'app'}>
      <div className="level">
        ...
        <button onClick={change} className="app__dark-mode-btn icon level-right">
          <FontAwesomeIcon icon={darkMode?faSun:faMoon} color={darkMode?'#FFA500':'#000'} />
        </button>
